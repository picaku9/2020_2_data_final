...
if __name__ == '__main__':
    ...
    victim = SklearnClassifier(getRF())
    surrogate = SklearnClassifier(getRF())

    mmclassifier = DrebinDataset(data_dir=DATA_DIR,training_size=TRAINING_SET_SIZE,reduce_features=DO_FEATURE_SELECTION, no_of_features=NO_OF_FEATURES, seed=SAMPLING_SEED,sample=DO_SAMPLE)
    
    tb.register_dataset(mmclassifier)
